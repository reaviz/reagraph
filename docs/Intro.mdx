...
<div style={{ margin: '0 auto', maxWidth: '600px', color: 'white', textAlign: 'center' }}>
  ...
  Checkout Unify Viz, our premium offering 300+ Figma and React professionally designed data visualization components.  <a href="https://unifyviz.com" target="_blank">Learn more →</a>
</div>
