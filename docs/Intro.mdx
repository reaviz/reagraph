...
<div style={{ margin: '0 auto', maxWidth: '600px', color: 'white', textAlign: 'center' }}>
  ...
  <a href="https://reachat.dev?utm=reagraph" target="_blank" style={{ background: 'black', padding: 5, borderRadius: 5, position: 'absolute', bottom: 5, right: 5, width: 325 }}>
    <img src={img} alt="reachat" />
    Checkout <strong>reachat</strong>, Open-source UI toolkit for building Chat Experiences in React →
  </a>
