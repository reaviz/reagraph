...
const Node = ({
  ...
  const labelComponent = useMemo(
    () => {
      var _a3, _b3, _c2;
      return labelVisible && (labelVisible || isSelected || active) && label && /* @__PURE__ */ jsxs(Fragment, { children: [
...
const Edge$1 = ({
  ...
  const labelComponent = useMemo(
    () => labelVisible && label && /* @__PURE__ */ jsx(
      a.group,
      {
...
function useEdgeGeometry(arrowPlacement, interpolation) {
  ...
  useRef(new BoxGeometry(0, 0, 0));
  const baseArrowGeometryRef = useRef();
...
const Edge = ({
  ...
  return /* @__PURE__ */ jsxs("group", { children: [
    labelVisible && label && /* @__PURE__ */ jsx(a.group, { position: labelPosition, children: /* @__PURE__ */ jsx(Label, { ...labelProps }) }),
...
const Cluster = ({
  ...
  const cluster = useMemo(
    () => {
      var _a3, _b3, _c2;
      return theme.cluster && /* @__PURE__ */ jsx(
        a.group,
        {
          ...
          children: onRender ? onRender({
            ...
            ((_a3 = theme.cluster) == null ? void 0 : _a3.label) && /* @__PURE__ */ jsx(a.group, { position: labelPosition, children: /* @__PURE__ */ jsx(
              Label,
              {
                text: label,
                opacity,
