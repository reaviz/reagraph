...
(function(global, factory) {
  ...
  const Node = ({
    ...
    glodrei.useCursor(active && !isDragging && onClick !== void 0, "pointer");
    glodrei.useCursor(
      active && draggable && !isDraggingCurrent && onClick === void 0,
      "grab"
    );
    glodrei.useCursor(isDraggingCurrent, "grabbing");
    ...
    const labelComponent = react.useMemo(
      () => {
        var _a3, _b3, _c2;
        return labelVisible && (labelVisible || isSelected || active) && label && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
  ...
  const Edge$1 = ({
    ...
    const labelComponent = react.useMemo(
      () => labelVisible && label && /* @__PURE__ */ jsxRuntime.jsx(
        three$1.a.group,
        {
  ...
  function useEdgeGeometry(arrowPlacement, interpolation) {
    ...
    react.useRef(new three.BoxGeometry(0, 0, 0));
    const baseArrowGeometryRef = react.useRef();
  ...
  const Edge = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("group", { children: [
      ...
      contextMenu && edgeContextMenus.has(edge.id) && /* @__PURE__ */ jsxRuntime.jsx(glodrei.Html, { ...htmlProps, children: contextMenu({
        data: edge,
  ...
  const Cluster = ({
    ...
    const cluster = react.useMemo(
      () => {
        var _a3, _b3, _c2;
        return theme.cluster && /* @__PURE__ */ jsxRuntime.jsx(
          three$1.a.group,
          {
            ...
            children: onRender ? onRender({
              ...
              ((_a3 = theme.cluster) == null ? void 0 : _a3.label) && /* @__PURE__ */ jsxRuntime.jsx(three$1.a.group, { position: labelPosition, children: /* @__PURE__ */ jsxRuntime.jsx(
                Label,
                {
                  text: label,
                  opacity,
