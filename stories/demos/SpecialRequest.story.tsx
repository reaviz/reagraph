...
function ConcentricRings({ maxLevel }: { maxLevel: number }) {
  const colors = ['#D1C4E9', '#C5CAE9', '#e8e6f7'];
...
<svg width="50" height="50" viewBox="-3 -3 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
...
const coreSvg = (color = 'black') =>
  `data:image/svg+xml;base64,${btoa(`
    <svg width="50" height="50" viewBox="-7 -3 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
